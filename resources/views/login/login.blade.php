    ...
    <section class="wrapper">
        <div class="container">
            <div class="col-sm-8 offset-sm-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 text-center">
                <div class="logo">
                    <a href="{{ route('home.index') }}"><img src="{{ asset('userpanel/images/logo.png') }}" alt="img"/></a>
                </div>

                <form class="rounded bg-white shadow p-5" action="{{route('login')}}" method="post">
                    @csrf
                    <p class="text-dark fw-bolder fs-4 mb-2">Welcome to MayaStore! Please login</p>
                    ...
                    <a href="submit" class="btn btn-light login_with w-100 mb-3">
